...
public class Facility {
    ...
    private List<String> specialitiesOffered = new ArrayList<>();
    ...
    public Facility(String facilityId, String facilityName, String facilityType, String address,
                    ...
                    String managerName, String capacity, List<String> specialitiesOffered) {
    ...
    public void setSpecialitiesOffered(List<String> specialitiesOffered) {
        this.specialitiesOffered = specialitiesOffered;
    }

    public String getSpecialitiesAsString() {
        return String.join("|", specialitiesOffered);
    }
}
