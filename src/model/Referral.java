...
public class Referral {
    ...
    public Referral(String referralId, String patientId, String referringClinicianId,
                    ...
                    List<String> requestedInvestigations, String status, String appointmentId, String notes,
    ...
    public String getInvestigationsAsString() {
        return String.join("|", requestedInvestigations);
    }
}
